...
show_menu() {
    ...
    echo "╚════════════════════════════════════════════════╝"
    echo ""
    echo "  ${GREEN}1${NC}. 配置白名单并应用规则（完整流程）"
    echo "  ${GREEN}2${NC}. 仅获取百度IP列表（不应用）"
    echo "  ${GREEN}3${NC}. 查看当前iptables规则"
    echo "  ${GREEN}4${NC}. 保存当前规则"
    echo "  ${GREEN}5${NC}. 恢复历史规则"
    echo "  ${GREEN}6${NC}. 清除所有规则（恢复默认）"
    echo "  ${GREEN}7${NC}. 查看连接统计"
    echo "  ${GREEN}8${NC}. 编辑配置"
    echo "  ${GREEN}0${NC}. 退出"
    echo ""
    echo "────────────────────────────────────────────────"
}
